...
<head>
    ...
    <title>Lista de Turmas - Sistema de Gerenciamento</title>
            ...
            <div class="page-content">
                <div class="list-container">
                    <div class="list-header">
                        ...
                        <p class="list-subtitle">Gerencie todas as turmas do sistema</p>
                    </div>
                    ...
                    <div class="header-container">
                        <a href="ClassForm.jsp" class="btn btn-primary">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="edit_class.jsp?id=<%= turma.getId() %>" class="btn-action btn-editar">
                                            <i class="fas fa-edit"></i>
                                            Editar
                                        </a>
                                        <a href="delete_class.jsp?id=<%= turma.getId() %>" 
                                           class="btn-action btn-excluir"
                                           onclick="return confirm('Tem certeza que deseja excluir a turma \\'<%= turma.getNomeTurma() %>\\'? Esta ação não pode ser desfeita.')">
