...
public class CourseDAO {
    ...
    public boolean cadastrar(Course disciplina) throws ClassNotFoundException {
        String sql = "INSERT INTO disciplina (nome, descricao, carga_horaria, nivel, ativa, documento) "
                   + "VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = ConectaDB.conectar();
            ...
            stmt.setString(6, disciplina.getDocumento());
    ...
    public boolean atualizar(Course disciplina) throws ClassNotFoundException {
        String sql = "UPDATE disciplina SET nome=?, descricao=?, carga_horaria=?, nivel=?, ativa=?, documento=? "
                   + "WHERE id=?";
